...
<template:tmpt title="${menu003 }">
	<jsp:attribute name="sub_menu">
		...
		<UL class=s_dep02>
			...
			<LI class=on>
				<A class=indep3	href="javascript:void(0)" onclick="navigate('./pglobal.do','hpage_contents-service','GP')">
					${menu003 }
				</A>
			</LI>
			<LI>
	...
	<DIV class="con_head biz_ref">
		<DIV class=bcs>
				...
				<DIV class=hg>
					<H3>${menu003 }</H3>
					<P>${subTitle}</P>
					<IMG alt="posco ict vietnam" style="overflow: auto; float: right;margin-top: -150px;" src="img/global.jpg">
				</DIV>
				<!-- con_head -->
				<!-- con_body -->
