...
<%
	...
	request.setAttribute("itsbr000", Text.getText(resource, "itsbr000", null, locale));
	for(int i=6; i<=15; i++) {
	...
	<DIV class="con_head biz_ref">
		<DIV class=bcs>
				...
				<DIV class=hg>
					<H3>${menu006}</H3>
					<P>${itsbr000}</P>
					<IMG alt="posco ict vietnam" style="overflow: auto; float: right;margin-top: -150px;" src="img/ITS-icon.png">
				</DIV>
				<!-- con_head -->
				<!-- con_body -->
